...
const LoginSecured: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!username || !password) {
      setError("Trebuie să introduci atât username-ul cât și parola");
      return;
    }

    fetch("https://localhost:7024/api/Auth/loginsecured", {
      method: "POST",
